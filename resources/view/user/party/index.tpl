...
<title>{:getSetting('general_name')} - 我的派对</title>
...
<script>
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch(`/user/party/${partyId}`, {
                    ...
                    .then(data => {
                        if (data.ret === 1) {
                            Swal.fire('成功', data.msg, 'success').then(() => {
                                location.reload();
                            });
                        } else {
    ...
    function leaveParty(partyId) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch(`/user/party/${partyId}/leave`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    }
